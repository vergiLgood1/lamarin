...
export const useThemeToggle = ({
  ...
  const toggleTheme = useCallback(() => {
    ...
    const switchTheme = () => {
      // Menggunakan resolvedTheme agar lebih akurat menentukan target theme
  ...
  }, [setTheme, variant, start, blur, gifUrl, updateStyles, isDark]); // theme dihapus dari dep, pakai isDark saja
...
export const createAnimation = (
  ...
  // Circle with non-center start positions
  if (variant === "circle" && start !== "center") {
...
/**
 * Skiper 26 Theme Toggle — React + CSS View Transition API
